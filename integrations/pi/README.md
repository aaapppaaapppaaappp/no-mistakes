...
- validates each supported Responses item from `output_item.added` through its type-specific completion and `output_item.done` to the identical ordered terminal output before Pi can consume it.
